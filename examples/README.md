...
| 11 | [`11_coding_agent_mission.py`](11_coding_agent_mission.py) | Typed coding-agent task graph on the admitted Modal backend, with validators, authenticated live control, and direct monitoring | Modal control-plane access + Codex subscription + repository-scoped GitHub publication token; dry-run needs none |
