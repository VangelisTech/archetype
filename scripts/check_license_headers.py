...
def has_license_header(file_path: Path) -> bool:
    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            content = f.read()
            return "Copyright 2025 Vangelis Technologies Inc." in content and "Apache License" in content
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Check and add Apache 2.0 license headers to Python files')
    parser.add_argument('--fix', action='store_true', help='Automatically add missing license headers')
