...
SUPPLEMENTAL: dict[str, tuple[str, str]] = {
    ...
    "MissionRun": ("archetype.missions", "MissionRun"),
    "MissionResult": ("archetype.missions", "MissionResult"),
    "TaskResult": ("archetype.missions", "TaskResult"),
    "MissionsExtensionConfig": ("archetype.missions", "MissionsExtensionConfig"),
    "ExecutionProfile": ("archetype.missions", "ExecutionProfile"),
    "ExecutionProfileBinding": ("archetype.missions", "ExecutionProfileBinding"),
