...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"metrics": {"start_time": 3}}, "config_json.metrics.start_time"),
        ({"metrics": {"endTime": 3}}, "config_json.metrics.endTime"),
        ({"metrics": {"request_time": 3}}, "config_json.metrics.request_time"),
        ({"metrics": {"runtimeSeconds": 3}}, "config_json.metrics.runtimeSeconds"),
