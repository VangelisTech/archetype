...
class TestQueryRoutes:
    ...
    def test_get_entity_not_found(self, client, tmp_path):
        create_resp = client.post(
            "/worlds",
        ...
        # Entity 1 doesn't exist — no entities have been spawned
    ...
    def test_get_components_unknown_types(self, client, tmp_path):
        create_resp = client.post(
            "/worlds",
        ...
        # Position and Velocity don't exist as known component types — returns 400
