...
"""Synchronous runtime parity for typed fact tables."""
...
def test_sync_runtime_matches_file_pipeline_and_read_surfaces(tmp_path):
    ...
    with ArchetypeRuntime.sync() as runtime:
        world = runtime.world("sync-facts", storage=storage)
        ...
        assert world.write_facts("readings", direct).rows_written == 1
        assert world.facts("documents").to_pylist()[0]["text"] == "sync"
