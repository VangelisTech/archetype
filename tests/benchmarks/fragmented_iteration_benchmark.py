...
def main():
    temp_dir = ".archetype_benchmarks/fragmented_iteration"
    ...
    print("Running Fragmented Iteration Benchmark...")
    duration = run_benchmark(world)
    print(f"Fragmented Iteration Benchmark duration: {duration:.3f}s")
