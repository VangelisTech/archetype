...
def run_benchmark(world):
    ...
    for i in range(1, 1001):
        world.despawn(i + 1000) # Despawn the B entities
...
def main():
    temp_dir = ".archetype_benchmarks/entity_cycle"
    ...
    print("Running Entity Cycle Benchmark...")
    duration = run_benchmark(world)
    print(f"Entity Cycle Benchmark duration: {duration:.3f}s")
