...
async def main():
    temp_dir = ".archetype_benchmarks/packed_iteration_async"
    ...
    print("Running Packed Iteration Benchmark (Async)...")
    duration = await run_benchmark(world)
    print(f"Packed Iteration Benchmark (Async) duration: {duration:.3f}s")
