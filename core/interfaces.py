from typing import Protocol, runtime_checkable, List, Type, Optional, Dict, Any, Set, Tuple
...
class UpdateManagerInterface(Protocol):
    ...
    def commit(self, update_df: DataFrame) -> None: ...
...
class SystemInterface(Protocol):
    ...
    def execute(self, *args: Any, **kwargs: Any) -> Optional[DataFrame]: ...
