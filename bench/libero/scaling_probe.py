...
# Reuse the co-located driver image (py3.12 archetype, no [sim] extra) and the
# results volume, exactly like gepa_runner — the probe IS the runner's world
# loop with per-step timing wrapped around it.
