...
| [Agent Mission Transitions](agent-missions.md) | Mission domain and attempt authority | Top-level typed world graph plus app-owned claims, evidence gates, retry, exhaustion, and task advancement. |
