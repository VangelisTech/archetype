...
| [File artifacts](python/artifacts.md) | Declare files, configure bounded content-addressed storage, and retain portable references to indexed artifact occurrences. |
