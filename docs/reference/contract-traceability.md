...
| `recovery.control.fenced` | `recovery` | high | [docs/guide/fleet-recovery.md](../guide/fleet-recovery.md) — 4. Catalog clock, leases, and fencing | pytest: 5; static: 1 | `pr`, `main`, `release` |
