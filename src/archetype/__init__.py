...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ArtifactCandidate": ("archetype.app.artifacts", "ArtifactCandidate"),
    "ArtifactBundleRequest": ("archetype.app.artifacts", "ArtifactBundleRequest"),
    "ArtifactIndexRecord": ("archetype.app.artifacts", "ArtifactIndexRecord"),
    "ArtifactPublishReceipt": ("archetype.app.artifacts", "ArtifactPublishReceipt"),
    "ArtifactReconcileResult": ("archetype.app.artifacts", "ArtifactReconcileResult"),
    "ArtifactSourceResolver": ("archetype.app.artifacts", "ArtifactSourceResolver"),
    "ArtifactStoreConfig": ("archetype.app.artifacts", "ArtifactStoreConfig"),
    # App layer
    ...
    "ArtifactService": ("archetype.app", "ArtifactService"),
