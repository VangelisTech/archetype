...
not identity. This module is the storage-family boundary that joins a durable
record back to an interchangeable, schema-identical class tuple.
"""
...
from archetype.storage.catalog import SignatureRecord, schema_fingerprint
